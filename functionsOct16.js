 ...
 */
let helloMessage= sayHello("Byron");
 ...
 */
function calculateTip(totalCheck, tipPercent){
    return totalCheck * tipPercent;
}
console.log("Tip is $" + calculateTip(20,0.2));
/**
 * TODO:
...
console.log("Your new price is $" + applyDiscount(prompt("Please enter the original price"),
